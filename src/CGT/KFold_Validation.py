from src.CGD.GerenciaDados import base_recover,base_update
from src.CGD.Gest_KFold import saveKfold,upload_Kfold
from sklearn import cross_validation, svm
from time import time
from sklearn.metrics import classification_report, confusion_matrix, accuracy_score
from sklearn.neighbors import KNeighborsClassifier
from random import shuffle
from src.CIH.Screen import plot_confusion_matrix, saveImages_erro
import numpy as np
import copy
import os
...
def clean_Result():
    for root, dir, files in os.walk('.\\CGT'):
        for f in files:
            if f.endswith('.png'):
