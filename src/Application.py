...
error_file, name_test, name_pred = kf.accuracyK_Fold_KNN_YCBCR(save=True)
save_lbp_YCBCR(error_file, name_test, name_pred, 'KNN', 'YCBCR')

error_file, name_test, name_pred = kf.accuracyK_Fold_KNN_RGB(save=True)
save_lbp_RGB(error_file, name_test, name_pred, 'KNN', 'RGB')